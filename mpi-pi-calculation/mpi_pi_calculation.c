...
int main(int argc, char* argv[]){
	...
	int lN = N/np;
        ...
        printf("PI calculation from processor %s, rank %d  out of %d processors started with %d points\n",  processor_name, id, np, lN);
	...
	for(i = 0; i<lN;i++){
        ...
        printf("PI calculation from processor %s, rank %d  out of %d processors finish with %d hits\n",  processor_name, id, np, lhit);
